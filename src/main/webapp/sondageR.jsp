    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">Creer un sondage</p>
         ...
         <section class="page-section portfolio" id="portfolio">
                    ...
                    <div class="divider-custom-line"></div>
                        ...
                        <div>
                         ...
                         <div class="form-floating mb-3">                   
											<form method="get" action="AffannRes">
            ...
            <!-- Submit Button-->
            <button class="btn btn-primary btn-xl" id="submitButton" type="submit">D�poser</button>
            <h1><br /></h1>
           </form>
                                                 <%
