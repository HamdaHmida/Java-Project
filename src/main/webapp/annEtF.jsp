    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">Voir les annonces </p>
            </div>
        </header>
        <!-- Portfolio Section-->
        <section class="page-section portfolio" id="portfolio">
          ...
          <table class="table table-striped">
                                    ...
                                    try {
                                    PreparedStatement ps= conn.prepareStatement("select * from ann_foy ORDER BY DATE_ANN DESC;");
