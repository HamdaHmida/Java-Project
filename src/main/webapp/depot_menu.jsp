    ...
    <body class="sb-nav-fixed">
        ...
        <section class="page-section portfolio" id="portfolio">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Depot du menu</h2>
                <!-- Icon Divider-->
                ...
                <form action="depotMenu" method="get">
                <div>
                   
                 <h4>Entrer la date de debut de cette semaine: </h4>
                    <div class="form-floating mb-3">
                        <input class="form-control1" id="name" type="text" name="date" placeholder="dd-MM-yyyy" data-sb-validations="required" />
                        
                        <div class="invalid-feedback" data-sb-feedback="name:required">A date is required.</div>
                    </div>
                       <h4><br /></h4>
                    <h7>En debut de semaine, commencez par Lundi SVP </h7>
                     <h6><br /></h6>
                    <select name="jour" class="navbar-toggler text-uppercase font-weight-bold bg-primary text-white rounded" type="text" data-bs-toggle="collapse">
                    ...
                    <h7>Entrez les identifiants des plats SVP (voir plats disponibles) </h7>
                     <h6><br /></h6>
                    <div class="form-floating mb-3">
                        
                        <input  class="form-control1" id="pdej1" name="pdej1" type="text" placeholder="Plat1 ... " data-sb-validations="required" />
                        <input  class="form-control1" id="pdej2" name="pdej2" type="text" placeholder="Plat2..." data-sb-validations="required" />
                        <input  class="form-control1" id="pdej3" name="pdej3" type="text" placeholder="Plat3..." data-sb-validations="required" />
				...
				<h4>Dejeuner</h4>
                    ...
                    <div class="form-floating mb-3">
                        ...
                        <input  class="form-control1" id="dej1"  name ="dej1" type="text" placeholder="Entree ... " data-sb-validations="required" />
                        <input  class="form-control1" id="dej2" name="dej2" type="text" placeholder="Plat principal..." data-sb-validations="required" />
                        <input  class="form-control1" id="dej3" name="dej3" type="text" placeholder="Dessert..." data-sb-validations="required" />
                        <div class="invalid-feedback" data-sb-feedback="name:required">A name is required.</div>
                    </div>
                    ...
                    <div class="form-floating mb-3">
                        ...
                        <input  class="form-control1" id="din1" name="din1" type="text" placeholder="Entree ... " data-sb-validations="required" />
                        <input  class="form-control1" id="din2" name="din2" type="text" placeholder="Plat principal..." data-sb-validations="required" />
                        <input  class="form-control1" id="din3" name="din3" type="text" placeholder="Dessert..." data-sb-validations="required" />
                        <div class="invalid-feedback" data-sb-feedback="name:required">A name is required.</div>
                    </div>
